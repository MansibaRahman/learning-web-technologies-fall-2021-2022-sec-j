        ...
        ?>
            ...
            <td><?php 
                    if($ctg['ctg_status']==0){
                        echo "unpublished";
                ?>
                <a class="btn btn-sm btn-primary" href="?status=publish&&id=<?php echo $ctg['ctg_id']; ?>">Make Publish</a>
                <?php
                    }else{
                        echo "Published";
                ?>
            ...
            <td><a class="btn btn-sm btn-primary" href="edit_cat.php?status=edit&&id=<?php echo $ctg['ctg_id']; ?>">Edit</a>
                <a class="btn btn-sm btn-danger" href="?status=delete&&id=<?php echo $ctg['ctg_id']; ?>">Delete</a>
            </td>
            </tr>
        <?php
            }
